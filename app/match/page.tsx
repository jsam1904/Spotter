...
import { MapPin, MessageSquare, Clock, X, Heart, Sun, Moon, Menu } from "lucide-react"
...
const matchesData = [
  {
    ...
    image: "https://via.placeholder.com/400x600?text=Ana",
  ...
  },
  {
    ...
    image: "https://via.placeholder.com/400x600?text=Miguel",
  ...
  },
  {
    ...
    image: "https://via.placeholder.com/400x600?text=Laura",
  ...
  },
  {
    ...
    image: "https://via.placeholder.com/400x600?text=Carlos",
  ...
  },
  {
    ...
    image: "https://via.placeholder.com/400x600?text=Elena",
...
export default function FindMatches() {
  ...
  const handleSwipe = (info: PanInfo) => {
    if (info.offset.x > 100) {
      // Deslizamiento a la derecha - Me gusta
      x.set(200) // Animar hacia la derecha
      setTimeout(() => {
        likeProfile()
      }, 100)
    } else if (info.offset.x < -100) {
      // Deslizamiento a la izquierda - No me gusta
      x.set(-200) // Animar hacia la izquierda
      setTimeout(() => {
        dislikeProfile()
      }, 100)
    } else {
      // Si no se deslizó lo suficiente, volver al centro
      x.set(0)
    }
  }
  ...
  const likeProfile = () => {
    if (currentIndex < matches.length) {
      ...
      // Pequeño retraso para que se vea la animación antes de cambiar de tarjeta
      setTimeout(() => {
        setLikedProfiles([...likedProfiles, matches[currentIndex].id])
        setCurrentIndex(currentIndex + 1)
        x.set(0) // Resetear posición
      }, 200)
    }
  }
        ...
        <div className="space-y-4 md:space-y-6 max-w-4xl mx-auto">
          ...
          <Tabs defaultValue="discover" className="w-full">
            <TabsList className="w-full grid grid-cols-2">
              ...
              <TabsTrigger value="messages">Mensajes ({conversationsData.length})</TabsTrigger>
            </TabsList>

            <TabsContent value="discover" className="space-y-4 md:space-y-6">
              <Card className="overflow-hidden">
                <CardContent className="p-4 md:p-6">
                  <h3 className="font-semibold mb-4">Filtros</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-medium">Distancia máxima: {distance[0]} km</label>
              ...
              <div className="flex flex-col items-center justify-center">
                {currentIndex >= matches.length ? (
                  ...
                  <div className="relative h-[400px] sm:h-[450px] md:h-[500px] w-full max-w-xs sm:max-w-sm md:max-w-md mx-auto">
                    <div className="relative w-full h-full">
                      {/* Tarjeta anterior (solo visible en pantallas medianas y grandes) */}
                      {currentIndex > 0 && (
                        <div
                      ...
                      {/* Tarjeta siguiente (solo visible en pantallas medianas y grandes) */}
                      ...
                      >
                        <Card className="h-full overflow-hidden shadow-lg flex flex-col">
                          <div className="relative h-3/5 sm:h-2/3 w-full bg-gray-200">
                            <img
                          ...
                          <div className="flex-1 flex flex-col justify-between bg-gradient-to-t from-black/80 to-transparent p-3 sm:p-4 md:p-6">
                            ...
                            <div className="flex justify-center gap-4 mt-2 sm:mt-4 md:mt-6">
                              <Button
                                onClick={dislikeProfile}
                                size="icon"
                                className="h-10 w-10 sm:h-12 sm:w-12 md:h-14 md:w-14 rounded-full bg-white border-2 border-red-500 hover:bg-red-50"
                              >
                              ...
                              <Button
                                onClick={likeProfile}
                                size="icon"
                                className="h-10 w-10 sm:h-12 sm:w-12 md:h-14 md:w-14 rounded-full bg-white border-2 border-green-500 hover:bg-green-50"
                              >
